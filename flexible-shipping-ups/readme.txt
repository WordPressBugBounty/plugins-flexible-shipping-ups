...
= 3.8.0 - 2026-07-20 =
* Improved UPS REST API response handling
...
= 3.7.1 - 2026-07-06 =
* Fixed unnecessary UPS API notices displayed on fresh installations
...
= 3.6.5 - 2026-03-30 =
* Added `intl` and `curl` PHP module requirements

= 3.6.4 - 2026-03-16 =
* Fixed token refresh scheduler
...
= 3.4.5 - 2025-08-21 =
* Fixed Client Credentials Token refresh

= 3.4.4 - 2025-08-11 =
* Added support for WooCommerce 10.2

= 3.4.3 - 2025-08-05 =
* Fixed 404 error on a missing CSS file

= 3.4.2 - 2025-08-04 =
* Added support for WooCommerce 10.1

= 3.4.1 - 2025-07-28 =
* Fixed access points data saving in Block-based checkout
* Fixed help links

= 3.4.0 - 2025-07-21 =
* Added communication regarding the auth code
