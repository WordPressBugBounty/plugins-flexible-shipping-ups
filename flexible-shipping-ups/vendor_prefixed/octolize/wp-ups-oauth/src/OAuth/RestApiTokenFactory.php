...
class RestApiTokenFactory
{
    ...
    {
        $token_option = new TokenOption($authorization_type === UpsSettingsDefinition::AUTH_CODE ? $option_name : $option_name . '_client_credentials');
        ...
        $this->add_hookable(new HookableObjects(new OAuthUrl(), $token_option, $rest_api_token, $logger, $settings_url, $app));
