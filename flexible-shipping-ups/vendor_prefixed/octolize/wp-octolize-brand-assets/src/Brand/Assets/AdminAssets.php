...
namespace UpsFreeVendor\Octolize\Brand\Assets;
 ...
 *
 */
class AdminAssets implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        if ($this->should_show === null || $this->should_show instanceof \UpsFreeVendor\WPDesk\ShowDecision\ShouldShowStrategy && $this->should_show->shouldDisplay()) {
