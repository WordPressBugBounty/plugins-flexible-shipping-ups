...
class Plugin implements \JsonSerializable
{
    ...
    {
        return $this->category === \UpsFreeVendor\Octolize\ShippingExtensions\Plugin\PluginFactory::get_categories()[\UpsFreeVendor\Octolize\ShippingExtensions\Plugin\PluginFactory::CATEGORY_BUNDLES] ? \__('Buy bundle →', 'flexible-shipping-ups') : \__('Buy plugin →', 'flexible-shipping-ups');
    }
}
