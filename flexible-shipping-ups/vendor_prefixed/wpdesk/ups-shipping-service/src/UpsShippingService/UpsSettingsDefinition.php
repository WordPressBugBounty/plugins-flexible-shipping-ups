...
class UpsSettingsDefinition extends SettingsDefinition
{
    ...
    public function get_form_fields()
    {
        ...
        $rest_api_description = sprintf('<h4>%1$s</h4> %2$s %3$s', __('REST API', 'flexible-shipping-ups'), sprintf('<strong>%1$s</strong><br/>%2$s', __('Auth code', 'flexible-shipping-ups'), sprintf(__('To connect to the API using OAuth, select "REST API Auth Code" and click "Authorize". For more information visit our %1$sdocumentation%2$s.', 'flexible-shipping-ups'), sprintf('<a href="%1$s" target="_blank">', $docs_link), '</a>')), sprintf('<br/><br/><strong>%1$s</strong><br/>%2$s', __('Client credentials', 'flexible-shipping-ups'), sprintf(__('You need to create a UPS application to use this method. %1$sClick here%2$s for a detailed guide.', 'flexible-shipping-ups'), sprintf('<a href="%1$s" target="_blank">', $docs_link), '</a>')));
        $docs_link = 'https://www.ups.com/upsdeveloperkit';
        $xml_api_description = sprintf('<h4>%1$s</h4> %2$s', __('XML API', 'flexible-shipping-ups'), sprintf('<strong>%1$s</strong><br/>%2$s', __('API Access Key - XML API', 'flexible-shipping-ups'), sprintf(__('This is a deprecated way to connect to XML API. For more information visit %1$sthis site%2$s.', 'flexible-shipping-ups'), sprintf('<a href="%1$s" target="_blank">', $docs_link), '</a>')));
        $description = sprintf(__('Making a connection with UPS API requires a tailored approach depending on chosen options:%1$s%2$s', 'flexible-shipping-ups'), $rest_api_description, $xml_api_description);
        $connection_fields = [self::SHIPPING_METHOD_TITLE => ['title' => __('UPS', 'flexible-shipping-ups'), 'type' => 'title', 'description' => $description], self::API_SETTINGS_TITLE => [
