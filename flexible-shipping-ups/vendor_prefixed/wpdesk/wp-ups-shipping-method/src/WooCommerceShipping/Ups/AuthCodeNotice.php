...
class AuthCodeNotice implements Hookable
{
    ...
    {
        return UpsSettingsDefinition::API_TYPE_REST === ($this->ups_settings[UpsSettingsDefinition::API_TYPE] ?? null) && UpsSettingsDefinition::AUTH_CODE === ($this->ups_settings[UpsSettingsDefinition::AUTHORIZATION_TYPE] ?? null);
    }
}
