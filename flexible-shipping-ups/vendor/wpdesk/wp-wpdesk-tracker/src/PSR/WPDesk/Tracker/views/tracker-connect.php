...
?><div id="wpdesk_tracker_connect" class="plugin-card">
	<div class="message plugin-card-top">
		<span><img class="logo" src="<?php echo esc_attr( $logo_url ); ?>" /></span>
		<p>
	...
	<div class="permissions">
		...
		<div class="permissions-details">
			<ul>
				...
				<li id="permission-events" class="permission events">
					...
					<div>
						...
						<p><?php printf( esc_html__( 'Current settings and usage information of %1$s plugins', 'wpdesk-tracker' ), esc_html( $shop_name ) ); ?></p>
					</div>
				</li>
			...
			<div class="terms">
				<a href="<?php echo esc_url_raw( $terms_url ); ?>" target="_blank"><?php esc_html_e( 'Find out more &raquo;', 'wpdesk-tracker' ); ?></a>
			</div>
		</div>
	</div>
</div>
