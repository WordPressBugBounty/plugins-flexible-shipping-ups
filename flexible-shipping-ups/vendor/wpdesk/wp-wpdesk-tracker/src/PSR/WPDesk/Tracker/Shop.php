...
class Shop {
	 ...
	 */
	private $shops_usage_tracking_pages = [
		'wpdesk.pl'            => 'https://www.wpdesk.pl/sk/',
		'wpdesk.net'           => 'https://www.wpdesk.net/sk/',
		'octolize.com'         => 'https://octolize.com/usage-tracking/',
		'shopmagic.app'        => 'https://www.shopmagic.app/sk/',
		'flexibleinvoices.com' => 'https://www.flexibleinvoices.com/sk/',
		'flexiblecoupons.net'  => 'https://www.flexiblecoupons.net/sk/',
	];

	/**
	 * @var array<string, string>
	 */
	private $shop_short_slug = [
		'wpdesk.pl'            => 'pl',
		'wpdesk.net'           => 'net',
		'shopmagic.app'        => 'sm',
		'flexibleinvoices.com' => 'fi',
		'flexiblecoupons.net'  => 'fc',
	];

	/**
	 * @var array<string, string>
	 */
	private $shops_usage_tracking_names = [
		'octolize.com' => 'Octolize',
	];
