		...
		public function get_data() {
			return [
				'settings' => [
					...
					'selling_locations'              => array_keys( WC()->countries->get_allowed_countries() ),
					...
					'block_product_editor_enabled'   => get_option( 'woocommerce_feature_product_block_editor_enabled' ),
					'uses_block_checkout'            => has_block( 'woocommerce/checkout', wc_get_page_id( 'checkout' ) ) ? 'yes' : 'no',
					'uses_block_cart'                => has_block( 'woocommerce/cart', wc_get_page_id( 'cart' ) ) ? 'yes' : 'no',
				],
			];
		}
	}
